    ...
    return (
        <div className="fixed top-0 left-0 h-screen w-[72px] m-0 flex flex-col bg-white dark:bg-gray-900 shadow-lg z-[999] ">
            ...
            <div className='fixed top-1/3 left-0 h-screen w-[72px] m-0 flex flex-col'>
                <Link to="/"><SideBarIcon icon={<AiFillHome size="28" />} text={'Home'} /></Link>
                <Link to="/about"><SideBarIcon icon={<BsFillPersonFill size="28" />} text={'About Me'} /></Link>
                <Link to="/projects"><SideBarIcon icon={<FaWrench size="28" />} text={"Projects"} /></Link>
                <Link to="/credits"><SideBarIcon icon={<FaStickyNote size="28" />} text={"Credits"} /></Link>
            </div>
            <div className='fixed left-0 inset-x-0 bottom-[7rem] w-[72px] m-0 flex flex-col rounded-3x'>
                <a href="https://github.com/cosrnic" target='_blank' rel="noreferrer"><SideBarIcon icon={<AiFillGithub size="24" />} text={"GitHub"} /></a>
                {/* <a href="https://twitter.com/cosrnic_" target='_blank' rel="noreferrer"><SideBarIcon icon={<FaTwitter size="24" />} text={"Twitter"} /></a> */}
            </div>
            <p className=' fixed left-0 bottom-5 inset-x-0 w-[72px] p-2  text-center text-sm font-poppins'>Made with ReactJS <FaReact className='ml-[25%] hover:text-blue-500 transition-all duration-300' size={24} /></p>
        </div>
