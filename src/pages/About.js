			...
			<div>
				...
				<div className="p-4 mt-4 bg-gray-900 rounded-lg border-2 border-blue-500 h-auto md:h-[200px] md:w-[500px] lg:h-[550px] w-auto lg:w-[700px]">
					<span className="lg:text-lg text-justify">
						Hey, I'm Cosmic and I make things. <br /> What things? Well lots of
						things, such as Minecraft Plugins, Discord Bots, Websites, Logos and
						More.
						<br />
						<br />
						Socials
						...
						<span className="mt-2 inline-flex p-2">
							...
							>
								<FaTwitter
									size={22}
									className="hover:text-blue-500 transition-all outline border-1 outline-offset-[5px] rounded-full"
								/>
							</a>
							<a
							...
							>
								<FaYoutube
									size={22}
									className="ml-6 hover:text-blue-500 transition-all outline border-1 outline-offset-[5px] rounded-full"
								/>
							</a>
							<a
						...
						<a
							href="https://www.youtube.com/user/JoshChaceHD"
							rel="noreferrer"
							target={"_blank"}
						>
						...
						and{" "}
						<a
							href="https://www.youtube.com/c/DJBOOTYBUTT"
							rel="noreferrer"
							target={"_blank"}
						>
							<span className="font-bold hover:underline text-blue-500">
						...
						<a
							href="https://youtu.be/WriCXaW2ZuU"
							rel="noreferrer"
							target={"_blank"}
						>
						...
						,{" "}
						<a
							href="https://youtu.be/9TMymE2IpzY"
							rel="noreferrer"
							target={"_blank"}
						>
							<span className="text-blue-500 hover:underline">
								Dying Lately(full album) - Jake Hill
							</span>
						</a>
						,{" "}
						<a
							href="https://youtu.be/GYwOWO929R0"
							rel="noreferrer"
							target={"_blank"}
						>
							<span className=" text-blue-500 hover:underline">
						...
						<img
							src={Flag}
							alt=""
							className="h-[25px] w-auto rounded inline-flex"
						/>
					</span>
				</div>
			</div>
